insert into chouette_info(id, xmlns, xmlnsurl, referential, organisation, cuser, regtopp_version, regtopp_coordinate_projection,data_format,enable_validation,allow_create_missing_stop_place, enable_stop_place_id_mapping, enable_clean_import, enable_auto_import, enable_auto_validation, enable_blocks_export, generate_dated_service_journey_ids, google_upload, google_qa_upload) values (1, 'flybussekspressen', 'http://www.ns.1','flybussekspressen', 'Rutebanken', 'admin@rutebanken.org', 'R12', 'EPSG:32632','regtopp',false,true,true,false,true,true, false, false, false, false);
insert into chouette_info(id, xmlns, xmlnsurl, referential, organisation, cuser, regtopp_version, regtopp_coordinate_projection,data_format,enable_validation,allow_create_missing_stop_place, enable_stop_place_id_mapping, enable_clean_import, enable_auto_import, enable_auto_validation, enable_blocks_export, generate_dated_service_journey_ids, google_upload, google_qa_upload) values (2, 'flybussekspressen2', 'http://www.ns.2','flybussekspressen2', 'Rutebanken2', 'admin2@rutebanken.org', 'R12', 'EPSG:32632','regtopp',false,true,true,false,true,true, false, false, false, false);
insert into chouette_info(id, xmlns, xmlnsurl, referential, organisation, cuser, regtopp_version, regtopp_coordinate_projection,data_format,enable_validation,allow_create_missing_stop_place, enable_stop_place_id_mapping, enable_clean_import, enable_auto_import, enable_auto_validation, enable_blocks_export, generate_dated_service_journey_ids, google_upload, google_qa_upload) values (3, 'rb_flybussekspressen', 'http://www.ns.2','rb_flybussekspressen', 'Rutebanken', 'admin2@rutebanken.org', 'R12', 'EPSG:32632','regtopp',false,true,true,false,true,true, false, false, false, false);
