package no.rutebanken.baba.organisation;

public class TestConstantsOrganisation {

	public static final String CODE_SPACE_ID = "tst";

	public static final String ORGANISATION_ID = "TST:Authority:OrgTest";
