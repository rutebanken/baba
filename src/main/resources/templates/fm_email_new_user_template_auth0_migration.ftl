...
<body>
<h4>${message("user.migration.header")} ${user.contactDetails.firstName} ${user.contactDetails.lastName}</h4>
...
<p>
<a href="${userGuideLink}">${message("user.migration.email.user.guide.link.text")}</a>
</p>
