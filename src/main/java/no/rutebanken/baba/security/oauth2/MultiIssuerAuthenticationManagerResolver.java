...
public class MultiIssuerAuthenticationManagerResolver
    ...
    @Value("${baba.oauth2.resourceserver.keycloak.jwt.audience}")
    private String keycloakAudience;

    @Value("${baba.oauth2.resourceserver.keycloak.jwt.issuer-uri}")
    private String keycloakIssuer;

    @Value("${baba.oauth2.resourceserver.keycloak.jwt.jwkset-uri}")
